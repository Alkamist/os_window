...
//     window._mouse_x, window._mouse_y = mouse_position(window)
...
// mouse_position :: proc(window: ^Window) -> (x, y: int) {
//     pos: win32.POINT
...
//         window._mouse_x = int(win32.GET_X_LPARAM(lparam))
//         window._mouse_y = int(win32.GET_Y_LPARAM(lparam))
...
//                 window.on_mouse_enter(window, window._mouse_x, window._mouse_y)
//             }
//         }
//         if window.on_mouse_move != nil {
//             window.on_mouse_move(window, window._mouse_x, window._mouse_y)
//         }

//     case win32.WM_MOUSELEAVE:
//         window._is_hovered = false
//         if window.on_mouse_exit != nil {
//             window.on_mouse_exit(window,  window._mouse_x, window._mouse_y)
//         }
...
//             window.on_mouse_press(window, _to_mouse_button(msg, wparam), window._mouse_x, window._mouse_y)
//         }
...
//             window.on_mouse_release(window, _to_mouse_button(msg, wparam), window._mouse_x, window._mouse_y)
//         }
